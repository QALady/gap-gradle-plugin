...
class GapWMManualPluginTasks extends WatchmenTask {
	...
	public void executeCreateLinksForApprovalAndRejection() {
		try {
			shellCommand.execute(["ectool", "setProperty", """/myJob/report-urls/Approve""", """/server/baseUrl]commander/runProcedure.phprunNow=1&projectName=/myJobStep/projectName/&procedureName=Set%20approval%20status%20property&numParameters=2&parameters1_name=jobId&parameters1_value=/myJob/jobId/&parameters2_name=approvalStatus&parameters2_value=approved"""])
