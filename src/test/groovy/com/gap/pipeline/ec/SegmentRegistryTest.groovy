...
class SegmentRegistryTest {
    ...
    public void setUp(){
        ...
        def segmentConfig = new SegmentConfig('http://svn.gap.dev/path/to/repo', '/dev/shm/1234/job_id', '/mnt/electric-commander/workspace/job_id', 'build.gradle', false,'TestProject','TestProcedure')
    ...
    public void populate_shouldSetSegmentConfigValues(){
        ...
        verify(commander).setECProperty(sameString("/projects[WM Segment Registry]/SegmentRegistry/Project Name:Procedure Name/projectName"), 'TestProject')
        verify(commander).setECProperty(sameString("/projects[WM Segment Registry]/SegmentRegistry/Project Name:Procedure Name/procedureName"), 'TestProcedure')
    }
